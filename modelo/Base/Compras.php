...
/**
 * Base class that represents a row from the 'compras' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Compras implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ComprasTableMap';
    ...
    /**
     * Initializes internal state of Base\Compras object.
     */
    ...
    /**
     * Compares this with another <code>Compras</code> instance.  If
     * <code>obj</code> is an instance of <code>Compras</code>, delegates to
     * <code>equals(Compras)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Compras The current object, for fluid interface
     */
     ...
     * @return $this|\Compras The current object (for fluent API support)
     */
    public function setIdcompra($v)
    {
        ...
        if ($this->idcompra !== $v) {
            $this->idcompra = $v;
            $this->modifiedColumns[ComprasTableMap::COL_IDCOMPRA] = true;
        }
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== null || $dt !== null) {
            if ($this->fecha === null || $dt === null || $dt->format("Y-m-d") !== $this->fecha->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ComprasTableMap::COL_FECHA] = true;
            }
    ...
    public function setDetalle($v)
    {
        ...
        if ($this->detalle !== $v) {
            $this->detalle = $v;
            $this->modifiedColumns[ComprasTableMap::COL_DETALLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ComprasTableMap::translateFieldName('Idcompra', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idcompra = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ComprasTableMap::translateFieldName('Fecha', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->fecha = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ComprasTableMap::translateFieldName('Detalle', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ComprasTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Compras'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildComprasQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Compras::setDeleted()
     * @see Compras::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildComprasQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ComprasTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ComprasTableMap::COL_IDCOMPRA)) {
            $modifiedColumns[':p' . $index++]  = 'idcompra';
        }
        if ($this->isColumnModified(ComprasTableMap::COL_FECHA)) {
            $modifiedColumns[':p' . $index++]  = 'fecha';
        }
        if ($this->isColumnModified(ComprasTableMap::COL_DETALLE)) {
    ...
    {
        $pos = ComprasTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Compras'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Compras'][$this->hashCode()] = true;
        $keys = ComprasTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ComprasTableMap::COL_IDCOMPRA)) {
            $criteria->add(ComprasTableMap::COL_IDCOMPRA, $this->idcompra);
        }
        if ($this->isColumnModified(ComprasTableMap::COL_FECHA)) {
            $criteria->add(ComprasTableMap::COL_FECHA, $this->fecha);
        }
        if ($this->isColumnModified(ComprasTableMap::COL_DETALLE)) {
            $criteria->add(ComprasTableMap::COL_DETALLE, $this->detalle);
        }
    ...
    {
        $criteria = ChildComprasQuery::create();
        $criteria->add(ComprasTableMap::COL_IDCOMPRA, $this->idcompra);
     ...
     * If this ChildCompras is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCompras The current object (for fluent API support)
     */
    public function setDetallecomprass(Collection $detallecomprass, ConnectionInterface $con = null)
    {
        ...
        foreach ($detallecomprassToDelete as $detallecomprasRemoved) {
            $detallecomprasRemoved->setCompras(null);
        }
    ...
    protected function doAddDetallecompras(ChildDetallecompras $detallecompras)
    {
        ...
        $detallecompras->setCompras($this);
    }
    ...
    public function removeDetallecompras(ChildDetallecompras $detallecompras)
    {
        if ($this->getDetallecomprass()->contains($detallecompras)) {
            ...
            $detallecompras->setCompras(null);
        }
     ...
     * Otherwise if this Compras is new, it will return
     * an empty collection; or if this Compras has previously
     * been saved, it will retrieve related Detallecomprass from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Compras.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildDetallecompras[] List of ChildDetallecompras objects
     */
    public function getDetallecomprassJoinProductos(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildDetallecomprasQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ComprasTableMap::DEFAULT_STRING_FORMAT);
    }
