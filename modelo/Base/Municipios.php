...
/**
 * Base class that represents a row from the 'municipios' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Municipios implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MunicipiosTableMap';
    ...
    /**
     * Initializes internal state of Base\Municipios object.
     */
    ...
    /**
     * Compares this with another <code>Municipios</code> instance.  If
     * <code>obj</code> is an instance of <code>Municipios</code>, delegates to
     * <code>equals(Municipios)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Municipios The current object, for fluid interface
     */
     ...
     * @return $this|\Municipios The current object (for fluent API support)
     */
    public function setIdmunicipio($v)
    {
        ...
        if ($this->idmunicipio !== $v) {
            $this->idmunicipio = $v;
            $this->modifiedColumns[MunicipiosTableMap::COL_IDMUNICIPIO] = true;
        }
    ...
    public function setIddepartamento($v)
    {
        ...
        if ($this->iddepartamento !== $v) {
            ...
            $this->modifiedColumns[MunicipiosTableMap::COL_IDDEPARTAMENTO] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[MunicipiosTableMap::COL_NOMBRE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MunicipiosTableMap::translateFieldName('Idmunicipio', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idmunicipio = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MunicipiosTableMap::translateFieldName('Iddepartamento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iddepartamento = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MunicipiosTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = MunicipiosTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Municipios'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMunicipiosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Municipios::setDeleted()
     * @see Municipios::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMunicipiosQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MunicipiosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MunicipiosTableMap::COL_IDMUNICIPIO)) {
            $modifiedColumns[':p' . $index++]  = 'idmunicipio';
        }
        if ($this->isColumnModified(MunicipiosTableMap::COL_IDDEPARTAMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'iddepartamento';
        }
        if ($this->isColumnModified(MunicipiosTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }

        $sql = sprintf(
            'INSERT INTO municipios (%s) VALUES (%s)',
    ...
    {
        $pos = MunicipiosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Municipios'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Municipios'][$this->hashCode()] = true;
        $keys = MunicipiosTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdmunicipio(),
            $keys[1] => $this->getIddepartamento(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdmunicipio($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setIddepartamento($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MunicipiosTableMap::COL_IDMUNICIPIO)) {
            $criteria->add(MunicipiosTableMap::COL_IDMUNICIPIO, $this->idmunicipio);
        }
        if ($this->isColumnModified(MunicipiosTableMap::COL_IDDEPARTAMENTO)) {
            $criteria->add(MunicipiosTableMap::COL_IDDEPARTAMENTO, $this->iddepartamento);
        }
        if ($this->isColumnModified(MunicipiosTableMap::COL_NOMBRE)) {
            $criteria->add(MunicipiosTableMap::COL_NOMBRE, $this->nombre);
        }
    ...
    {
        $criteria = ChildMunicipiosQuery::create();
        $criteria->add(MunicipiosTableMap::COL_IDMUNICIPIO, $this->idmunicipio);
    ...
    {
        $validPk = null !== $this->getIdmunicipio();
    ...
    /**
     * Generic method to set the primary key (idmunicipio column).
     *
    ...
    {
        return null === $this->getIdmunicipio();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Municipios (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Municipios Clone of current object.
     * @throws PropelException
     */
    ...
    public function getDepartamentos(ConnectionInterface $con = null)
    {
        if ($this->aDepartamentos === null && ($this->iddepartamento !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDepartamentos->addMunicipioss($this);
             */
        }
     ...
     * If this ChildMunicipios is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMunicipios The current object (for fluent API support)
     */
    public function setUsuarioss(Collection $usuarioss, ConnectionInterface $con = null)
    {
        ...
        foreach ($usuariossToDelete as $usuariosRemoved) {
            $usuariosRemoved->setMunicipios(null);
        }
     ...
     * Otherwise if this Municipios is new, it will return
     * an empty collection; or if this Municipios has previously
     * been saved, it will retrieve related Usuarioss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Municipios.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildUsuarios[] List of ChildUsuarios objects
     */
    public function getUsuariossJoinDepartamentos(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUsuariosQuery::create(null, $criteria);
        $query->joinWith('Departamentos', $joinBehavior);
    ...
    {
        if (null !== $this->aDepartamentos) {
            $this->aDepartamentos->removeMunicipios($this);
        }
    ...
    {
        return (string) $this->exportTo(MunicipiosTableMap::DEFAULT_STRING_FORMAT);
    }
