...
*/
abstract class Tienda implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TiendaTableMap';
    ...
    /**
     * Initializes internal state of Base\Tienda object.
     */
    ...
    /**
     * Compares this with another <code>Tienda</code> instance.  If
     * <code>obj</code> is an instance of <code>Tienda</code>, delegates to
     * <code>equals(Tienda)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tienda The current object, for fluid interface
     */
     ...
     * @return $this|\Tienda The current object (for fluent API support)
     */
    public function setIdtienda($v)
    {
        ...
        if ($this->idtienda !== $v) {
            $this->idtienda = $v;
            $this->modifiedColumns[TiendaTableMap::COL_IDTIENDA] = true;
        }
    ...
    public function setDireccion($v)
    {
        ...
        if ($this->direccion !== $v) {
            $this->direccion = $v;
            $this->modifiedColumns[TiendaTableMap::COL_DIRECCION] = true;
        }
    ...
    public function setIddepartamento($v)
    {
        ...
        if ($this->iddepartamento !== $v) {
            ...
            $this->modifiedColumns[TiendaTableMap::COL_IDDEPARTAMENTO] = true;
        }
    ...
    public function setIdmunicipio($v)
    {
        ...
        if ($this->idmunicipio !== $v) {
            $this->idmunicipio = $v;
            $this->modifiedColumns[TiendaTableMap::COL_IDMUNICIPIO] = true;
        }
    ...
    public function setTelefono($v)
    {
        ...
        if ($this->telefono !== $v) {
            $this->telefono = $v;
            $this->modifiedColumns[TiendaTableMap::COL_TELEFONO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TiendaTableMap::translateFieldName('Idtienda', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idtienda = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TiendaTableMap::translateFieldName('Direccion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->direccion = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TiendaTableMap::translateFieldName('Iddepartamento', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iddepartamento = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TiendaTableMap::translateFieldName('Idmunicipio', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idmunicipio = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TiendaTableMap::translateFieldName('Telefono', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = TiendaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Tienda'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTiendaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Tienda::setDeleted()
     * @see Tienda::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTiendaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TiendaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TiendaTableMap::COL_IDTIENDA] = true;
        if (null !== $this->idtienda) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TiendaTableMap::COL_IDTIENDA . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TiendaTableMap::COL_IDTIENDA)) {
            $modifiedColumns[':p' . $index++]  = 'idtienda';
        }
        if ($this->isColumnModified(TiendaTableMap::COL_DIRECCION)) {
            $modifiedColumns[':p' . $index++]  = 'direccion';
        }
        if ($this->isColumnModified(TiendaTableMap::COL_IDDEPARTAMENTO)) {
            $modifiedColumns[':p' . $index++]  = 'iddepartamento';
        }
        if ($this->isColumnModified(TiendaTableMap::COL_IDMUNICIPIO)) {
            $modifiedColumns[':p' . $index++]  = 'idmunicipio';
        }
        if ($this->isColumnModified(TiendaTableMap::COL_TELEFONO)) {
    ...
    {
        $pos = TiendaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tienda'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tienda'][$this->hashCode()] = true;
        $keys = TiendaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdtienda(),
            $keys[1] => $this->getDireccion(),
            $keys[2] => $this->getIddepartamento(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdtienda($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setDireccion($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setIddepartamento($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIdmunicipio($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TiendaTableMap::COL_IDTIENDA)) {
            $criteria->add(TiendaTableMap::COL_IDTIENDA, $this->idtienda);
        }
        if ($this->isColumnModified(TiendaTableMap::COL_DIRECCION)) {
            $criteria->add(TiendaTableMap::COL_DIRECCION, $this->direccion);
        }
        if ($this->isColumnModified(TiendaTableMap::COL_IDDEPARTAMENTO)) {
            $criteria->add(TiendaTableMap::COL_IDDEPARTAMENTO, $this->iddepartamento);
        }
        if ($this->isColumnModified(TiendaTableMap::COL_IDMUNICIPIO)) {
            $criteria->add(TiendaTableMap::COL_IDMUNICIPIO, $this->idmunicipio);
        }
        if ($this->isColumnModified(TiendaTableMap::COL_TELEFONO)) {
            $criteria->add(TiendaTableMap::COL_TELEFONO, $this->telefono);
        }
    ...
    {
        $criteria = ChildTiendaQuery::create();
        $criteria->add(TiendaTableMap::COL_IDTIENDA, $this->idtienda);
    ...
    /**
     * Generic method to set the primary key (idtienda column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdtienda(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     * If this ChildTienda is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTienda The current object (for fluent API support)
     */
    public function setInventarios(Collection $inventarios, ConnectionInterface $con = null)
    {
        ...
        foreach ($inventariosToDelete as $inventarioRemoved) {
            $inventarioRemoved->setTienda(null);
        }
     ...
     * @return ObjectCollection|ChildInventario[] List of ChildInventario objects
     */
    public function getInventariosJoinProductos(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInventarioQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TiendaTableMap::DEFAULT_STRING_FORMAT);
    }
