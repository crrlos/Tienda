...
abstract class Roles implements ActiveRecordInterface
{
    ...
    public function setIdrol($v)
    {
        ...
        if ($this->idrol !== $v) {
            $this->idrol = $v;
            $this->modifiedColumns[RolesTableMap::COL_IDROL] = true;
        }
    ...
    public function setRol($v)
    {
        ...
        if ($this->rol !== $v) {
            $this->rol = $v;
            $this->modifiedColumns[RolesTableMap::COL_ROL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RolesTableMap::translateFieldName('Idrol', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idrol = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RolesTableMap::translateFieldName('Rol', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = RolesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[RolesTableMap::COL_IDROL] = true;
        if (null !== $this->idrol) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RolesTableMap::COL_IDROL . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(RolesTableMap::COL_IDROL)) {
            $modifiedColumns[':p' . $index++]  = 'idrol';
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROL)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdrol($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setRol($arr[$keys[1]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolesTableMap::COL_IDROL)) {
            $criteria->add(RolesTableMap::COL_IDROL, $this->idrol);
        }
        if ($this->isColumnModified(RolesTableMap::COL_ROL)) {
            $criteria->add(RolesTableMap::COL_ROL, $this->rol);
        }
