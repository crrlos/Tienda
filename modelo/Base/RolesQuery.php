 ...
 *
 *
 * @method     ChildRolesQuery orderByIdrol($order = Criteria::ASC) Order by the idrol column
 * @method     ChildRolesQuery orderByRol($order = Criteria::ASC) Order by the rol column
 *
 * @method     ChildRolesQuery groupByIdrol() Group by the idrol column
 * @method     ChildRolesQuery groupByRol() Group by the rol column
 *
 ...
 *
 * @method     ChildRolesQuery leftJoinUsuarios($relationAlias = null) Adds a LEFT JOIN clause to the query using the Usuarios relation
 * @method     ChildRolesQuery rightJoinUsuarios($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Usuarios relation
 * @method     ChildRolesQuery innerJoinUsuarios($relationAlias = null) Adds a INNER JOIN clause to the query using the Usuarios relation
 *
 * @method     ChildRolesQuery joinWithUsuarios($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Usuarios relation
 *
 * @method     ChildRolesQuery leftJoinWithUsuarios() Adds a LEFT JOIN clause and with to the query using the Usuarios relation
 * @method     ChildRolesQuery rightJoinWithUsuarios() Adds a RIGHT JOIN clause and with to the query using the Usuarios relation
 * @method     ChildRolesQuery innerJoinWithUsuarios() Adds a INNER JOIN clause and with to the query using the Usuarios relation
 *
 ...
 *
 * @method     ChildRoles findOneByIdrol(int $idrol) Return the first ChildRoles filtered by the idrol column
 * @method     ChildRoles findOneByRol(string $rol) Return the first ChildRoles filtered by the rol column *
 ...
 *
 * @method     ChildRoles requireOneByIdrol(int $idrol) Return the first ChildRoles filtered by the idrol column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildRoles requireOneByRol(string $rol) Return the first ChildRoles filtered by the rol column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildRoles[]|ObjectCollection findByIdrol(int $idrol) Return ChildRoles objects filtered by the idrol column
 * @method     ChildRoles[]|ObjectCollection findByRol(string $rol) Return ChildRoles objects filtered by the rol column
...
abstract class RolesQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT idrol, rol FROM roles WHERE idrol = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(RolesTableMap::COL_IDROL, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(RolesTableMap::COL_IDROL, $keys, Criteria::IN);
    }
    ...
    public function filterByIdrol($idrol = null, $comparison = null)
    {
        if (is_array($idrol)) {
            $useMinMax = false;
            if (isset($idrol['min'])) {
                $this->addUsingAlias(RolesTableMap::COL_IDROL, $idrol['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idrol['max'])) {
                $this->addUsingAlias(RolesTableMap::COL_IDROL, $idrol['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RolesTableMap::COL_IDROL, $idrol, $comparison);
    }
     ...
     * $query->filterByRol('%fooValue%'); // WHERE rol LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByRol($rol = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($rol)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $rol)) {
                $rol = str_replace('*', '%', $rol);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(RolesTableMap::COL_ROL, $rol, $comparison);
    }
    ...
    public function filterByUsuarios($usuarios, $comparison = null)
    {
        if ($usuarios instanceof \Usuarios) {
            return $this
                ->addUsingAlias(RolesTableMap::COL_IDROL, $usuarios->getIdrol(), $comparison);
    ...
    {
        if ($roles) {
            $this->addUsingAlias(RolesTableMap::COL_IDROL, $roles->getIdrol(), Criteria::NOT_EQUAL);
        }
