...
class RolesTableMap extends TableMap
{
     ...
     */
    const COL_IDROL = 'roles.idrol';

    /**
     * the column name for the rol field
     */
    const COL_ROL = 'roles.rol';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idrol', 'Rol', ),
        self::TYPE_CAMELNAME     => array('idrol', 'rol', ),
        self::TYPE_COLNAME       => array(RolesTableMap::COL_IDROL, RolesTableMap::COL_ROL, ),
        self::TYPE_FIELDNAME     => array('idrol', 'rol', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idrol' => 0, 'Rol' => 1, ),
        self::TYPE_CAMELNAME     => array('idrol' => 0, 'rol' => 1, ),
        self::TYPE_COLNAME       => array(RolesTableMap::COL_IDROL => 0, RolesTableMap::COL_ROL => 1, ),
        self::TYPE_FIELDNAME     => array('idrol' => 0, 'rol' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('rol', 'Rol', 'VARCHAR', false, 45, null);
    } // initialize()
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idrol', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Idrol', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('Idrol', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RolesTableMap::COL_IDROL);
            $criteria->addSelectColumn(RolesTableMap::COL_ROL);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(RolesTableMap::COL_IDROL, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(RolesTableMap::COL_IDROL) && $criteria->keyContainsValue(RolesTableMap::COL_IDROL) ) {
