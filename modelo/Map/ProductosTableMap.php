...
class ProductosTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Idproducto', 'Nombre', 'Detalle', 'Descripcion', 'Precio', 'Idsubcategoria', 'Iddescuento', 'Cantidad', ),
        self::TYPE_CAMELNAME     => array('idproducto', 'nombre', 'detalle', 'descripcion', 'precio', 'idsubcategoria', 'iddescuento', 'cantidad', ),
        self::TYPE_COLNAME       => array(ProductosTableMap::COL_IDPRODUCTO, ProductosTableMap::COL_NOMBRE, ProductosTableMap::COL_DETALLE, ProductosTableMap::COL_DESCRIPCION, ProductosTableMap::COL_PRECIO, ProductosTableMap::COL_IDSUBCATEGORIA, ProductosTableMap::COL_IDDESCUENTO, ProductosTableMap::COL_CANTIDAD, ),
        self::TYPE_FIELDNAME     => array('idproducto', 'nombre', 'detalle', 'descripcion', 'precio', 'idsubcategoria', 'iddescuento', 'cantidad', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Idproducto' => 0, 'Nombre' => 1, 'Detalle' => 2, 'Descripcion' => 3, 'Precio' => 4, 'Idsubcategoria' => 5, 'Iddescuento' => 6, 'Cantidad' => 7, ),
        self::TYPE_CAMELNAME     => array('idproducto' => 0, 'nombre' => 1, 'detalle' => 2, 'descripcion' => 3, 'precio' => 4, 'idsubcategoria' => 5, 'iddescuento' => 6, 'cantidad' => 7, ),
        self::TYPE_COLNAME       => array(ProductosTableMap::COL_IDPRODUCTO => 0, ProductosTableMap::COL_NOMBRE => 1, ProductosTableMap::COL_DETALLE => 2, ProductosTableMap::COL_DESCRIPCION => 3, ProductosTableMap::COL_PRECIO => 4, ProductosTableMap::COL_IDSUBCATEGORIA => 5, ProductosTableMap::COL_IDDESCUENTO => 6, ProductosTableMap::COL_CANTIDAD => 7, ),
        self::TYPE_FIELDNAME     => array('idproducto' => 0, 'nombre' => 1, 'detalle' => 2, 'descripcion' => 3, 'precio' => 4, 'idsubcategoria' => 5, 'iddescuento' => 6, 'cantidad' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
