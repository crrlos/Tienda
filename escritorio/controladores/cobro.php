...
if (isset($_POST["cantidad1"]) && is_numeric($_POST["cantidad1"]) &&
    ...
    if ($Pagadito->connect()) {
        ...
        if ($_POST["cantidad1"] > 0) {
            $Pagadito->add_detail($_POST["cantidad1"], $_POST["descripcion1"], $_POST["precio1"]);
        }
        if ($_POST["cantidad2"] > 0) {
            $Pagadito->add_detail($_POST["cantidad2"], $_POST["descripcion2"], $_POST["precio2"]);
        }
        if ($_POST["cantidad3"] > 0) {
            $Pagadito->add_detail($_POST["cantidad3"], $_POST["descripcion3"], $_POST["precio3"]);
        }
        ...
        $Pagadito->set_custom_param("param4", "Valor de param5");
